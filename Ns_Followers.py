...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='63249336934' #Enter UserID Here
        self.__username='educatar3' #Enter UserName Here
        self._session='63249336934:hrapBTca4Nfgkk:4:AYc_ASbF8pHaLpCFb88YE4JoufOUGetWcwpzY1CMvg' #Enter SessionID Here
